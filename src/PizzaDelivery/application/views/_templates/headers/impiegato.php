...
<nav class="navbar navbar-expand-lg navbar-dark bg-danger">
    <a class="navbar-brand text-truncate" href="<?php echo URL?>home/index">PizzaDelivery<span id='userTypeText'><?php if(isset($_SESSION['user'])){echo " • " . $_SESSION['user'][0]['tipoUtente'];}?></span></a>
